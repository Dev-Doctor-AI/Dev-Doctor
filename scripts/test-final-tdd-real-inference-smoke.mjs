...
console.log(`Running isolated Final TDD smoke with available models: ${models.join(', ')}`);
...
try {
  ...
  while (Date.now() < deadline) {
    const error = browserErrors.find(message => /Failed to generate TDD Doc|invalid technical design document/i.test(message));
