...
export const chatHistory = [
  {
    sender: 'ai',
    text: "Hello! I'm the Concierge for Dev Doctor AI. To get started, what is the official name for this project?"
  },
  {
    sender: 'user',
    text: rawInput
  ...
  {
    sender: 'ai',
    text: "That is an absolute goldmine of a concept! The Picky Pet is hilarious, high-retention, and keeping it to a single static screen with zero backend/cloud complexity is the smartest way to guarantee a fast, polished launch. Kids adore slapstick cause-and-effect humor (burps, squishes, chomps), and sneaking cognitive shape/color sorting in without feeling like school is textbook Montessori-meets-arcade design.\n\nI believe I have a clear vision for The Picky Pet now. Are you ready for me to compile this and begin the formal design critique?"
  },
  {
    sender: 'user',
    text: "Yes, let's compile the critique and generate the full project package!"
  },
  {
    sender: 'ai',
    text: "Fantastic! Compiling project data, generating technical critique, full Game Design Document, pitch deck, MVP definitions, TDD specifications, production asset lists, and modular freelance briefs now..."
  }
];
